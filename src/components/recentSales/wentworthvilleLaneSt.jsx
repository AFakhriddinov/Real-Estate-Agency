...
import photo1 from '../images/wentworthville1.jpg';
import photo2 from '../images/wentworthville2.jpg';
import photo3 from '../images/wentworthville3.jpg';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faBed, faBath, faCar } from '@fortawesome/free-solid-svg-icons';
import agentPhoto from '../images/Andy.avif';
import logo from '../images/logo2.png';

export default function WentworthvilleLaneSt() {
  return (
    <div className="soldProperties-container">
      ...
      <div className="soldProperties-heading ">
        ...
        <div className="top-links right-container">
          <h5>1/78-80 Lane Street, Wentworthville, NSW 2145</h5>
          <h6 className="sold-h6-right">SOLD</h6>
          <h6 className="sold-h6-right">$ 483,000</h6>
